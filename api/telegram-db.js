...
export default async function handler(req, res) {
  ...
  try {
    ...
    await db.execute(`CREATE TABLE IF NOT EXISTS telegram_listings (
      ...
      date INTEGER, text TEXT, price TEXT, zona TEXT, duration_type TEXT, deposit TEXT,
      email TEXT, whatsapp TEXT, phone TEXT, sender TEXT, link TEXT,
